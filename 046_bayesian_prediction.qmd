...
-   campionare $y^{rep} \sim p(y^{rep} \mid \theta_i)$, ovvero scegliere a caso un'osservazione dalla funzione di verosimiglianza condizionata al valore del parametro definito nel passo precedente.
