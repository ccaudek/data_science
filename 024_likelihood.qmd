...
Se i dati di @zetschefuture2019 vengono riassunti da una proporzione allora è sensato adottare un modello probabilistico binomiale quale meccanismo generatore dei dati:
...
```{r, fig.cap="Funzione di verosimiglianza nel caso di 23 successi in 30 prove."}
n <- 30
y <- 23
...
```{r, fig.cap="Funzione di log-verosimiglianza nel caso di 23 successi in 30 prove."}
n <- 30
y <- 23
theta <- seq(0, 1, length.out = 100)
